...
with $ L $ being the size of the junction. Note, that the parameters $ B $, $ u $, $ \Delta $ and $ m $ are taken to be constant across the system.
 ...
 \end{gather} 
  ...
  The experimental justification of this choice is given in the chapter \ref{chap:discssion}, while call for it from theoretical point of view will arise further in this chapter.
