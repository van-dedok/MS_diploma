...
This leads us to two additional subcases. When $ M \gg n_\lambda\sim n_T$, the sum over $ r $ is dominated by the two largest terms: $ r=0,1 $ for $ -\pi<\varphi_0<\pi $.
