...
Separately we find:
\begin{gather}
	\intop_{0}^{1}\log n_{\lambda}d\lambda=\ln\frac{1}{T}+\intop_{0}^{1}\log\frac{\lambda^{2}}{1-\sqrt{1-\lambda^{2}}}d\lambda=\log\frac{1}{T}+\frac{\pi}{2}-1.	
\end{gather}
\begin{gather}
\intop_{0}^{1}\frac{1}{n_{\lambda}^{2}}d\lambda=\intop_{0}^{1}\frac{1}{\left[\log\frac{1}{T}+\log\frac{\lambda^{2}}{1-\sqrt{1-\lambda^{2}}}\right]^{2}}d\lambda=\frac{1}{(\log\frac{1}{T})^{2}}+O\left(\frac{1}{(\log\frac{1}{T})^{3}}\right)	
\end{gather}
...
s_{\lambda}
=
M\br{\log\frac{\alpha}{2}
-
2\log n_T
-\br{\pi-2}
-
\frac{(\pi-|\varphi_{0}|)^{2}}{n_T^{2}}+O\left(\frac{1}{n_T^{3}}\right)}
\end{gather}
...
\begin{gather}
	...
	\exp
	\left[
	\frac{2\abs{g_L}}{\omega}\br{\log\frac{\alpha}{2}
		-
		2\log n_T
		-\br{\pi-2}
		-
...
$K_{*}=M/n_{*}$. We write $
K_{*}=K_{0}+\xi,$ with $\xi \in \br{-\frac{1}{2}, \frac{1}{2}}$, so:
\begin{multline*}
\li_{-M}(e^{-n_{*}+i(\phi_{0}+\pi)})
\propto e^{-n_{*}(K_{*}-\xi)+M\ln(K_{0}-\xi)}=\\
